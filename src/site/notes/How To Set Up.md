...
6. find the following references, in your instance files.
   ![Pasted image 20260319205330.png](/img/user/Images/Pasted%20image%2020260319205330.png)
   note:
...
7. click the "Properties" dropdown in the solution explorer and open "AssemblyInfo.cs"
   
8. just under the using declarations copy and paste this:
...
9. you are now set up, this video documents how to install unity explorer and how to program a basic mod. 
